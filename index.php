    ...
    <style>
        * {
        ...
        .sessao {
            ...
            background-color: #333; /* Verde limão */
            color: #fff;
        }
...
<body>
    ...
    <section id="sessao-03">
        ...
        <p> Em 2018, foi formado o Ministério "Unidos em Cristo Vila Real Santista", inspirado na passagem de Atos 2, que diz: "E perseveravam na doutrina dos apóstolos, na comunhão, no partir do pão, e em cada um havia temor; muitos sinais e maravilhas eram realizados pelos apóstolos".</p>
        <p>O Ministério é liderado pela Pastora Alice Ferreira e seu esposo, o Presbítero Silvio, com o propósito de realizar obras para o Reino de Deus. Sua missão é ajudar os irmãos que necessitam da obra de Deus e, sempre, buscar a presença divina.</p>
        <p></p>
    ...
    <section id="sessao5" class="sessao">
        <div class="sessao5-container">
            ...
            <div class="social-icons">
                <a href="https://www.instagram.com/verdaadeiros_adoradores/?igsh=MW8zYXY1a2xvdTNsbA%3D%3D" target="_blank"><img src="https://th.bing.com/th/id/OIP.gR8GqQOrvovjmfq5oBNffgHaHa?w=176&h=180&c=7&r=0&o=5&pid=1.7" alt="Instagram" width= 100></a>
            </div>
        </div>
    </section>
